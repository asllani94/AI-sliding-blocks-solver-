...
public class SearchDFS {
    ...
    //stack for Depth Fist Search
    LinkedList<Grid> stack;
    ...
    //constructor
    public SearchDFS(Grid initialState,int targetBlock) {
    ...
    void doSearch() {
        ...
        //add our initial state to stack
    stack.push(currentState);
        ...
        while (!stack.isEmpty()) {
            ...
            if(stack.size()>this.nodesInMemory)
                nodesInMemory=stack.size();
